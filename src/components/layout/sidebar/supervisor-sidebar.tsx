...
import { supervisorMenuItems } from './supervisor-menu-items'
...
export default function SupervisorSidebar({ isOpen, onToggle }: SupervisorSidebarProps) {
            ...
            return (
              <Link key={item.id} href={item.href}>
                <motion.div
                  ...
                  style={{
                    backgroundColor: isActive ? colors.supervisorPrimary : 'transparent',
                  }}
                >
