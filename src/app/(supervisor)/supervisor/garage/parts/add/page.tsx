...
import { createPart, fetchPartCategories, fetchSuppliers, PartCategory } from '@/lib/api'
...
export default function AddPartPage() {
    ...
    useEffect(() => {
        const loadInitialData = async () => {
            try {
                ...
                toast({
                    title: "Error",
                    description: "Failed to load categories and suppliers. Please refresh the page.",
                    variant: "destructive"
                })
            } finally {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast({
                title: "Error",
                description: error.response?.data?.detail || "Failed to create part. Please try again.",
                variant: "destructive"
            })
        } finally {
            setLoading(false)
        ...
        >
            <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center gap-3">
                    ...
                    >
                        <Package size={20} style={{ color: colors.supervisorPrimary }} />
                    </div>
                    <div>
